...
public class Wings extends Force{
    /**
     * Constructor For the Wings Class. Takes 8 Parameters:
     ...
     */
    public Wings(String fleetRef, String force, int activationCost, int battleValue, Boolean cloakVal, Boolean skirmish, Boolean ambush, Boolean fight) {
