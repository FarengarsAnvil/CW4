...
public class Warbird extends Force{
    /**
     * Constructor For the Warbird Class. Takes 8 Parameters::
     ...
     */
    public Warbird(String fleetRef, String force, int activationCost, int battleValue, Boolean cloakVal, Boolean skirmish, Boolean ambush, Boolean fight) {
